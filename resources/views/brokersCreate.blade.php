...
<div class="container">
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>Cadastrar Corretor <small></small></h2>
            ...
            <div class="x_content">
              ...
              <form id="demo-form" action="{{ url('usuarios/corretores') }}" method="POST" data-parsley-validate>
                {{ csrf_field() }}
                ...
                <input type="text" id="creci" class="form-control" name="creci" required value="{{ old('creci') }}"/>
